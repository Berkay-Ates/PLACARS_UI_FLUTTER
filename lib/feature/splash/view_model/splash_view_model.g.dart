...
mixin _$SplashViewModel on _SplashViewModelBase, Store {
  ...
  late final _$isTokenExistsAtom =
      Atom(name: '_SplashViewModelBase.isTokenExists', context: context);
  ...
  late final _$checkUserTokenAsyncAction =
      AsyncAction('_SplashViewModelBase.checkUserToken', context: context);

  @override
  Future<void> checkUserToken() {
    return _$checkUserTokenAsyncAction.run(() => super.checkUserToken());
  }
